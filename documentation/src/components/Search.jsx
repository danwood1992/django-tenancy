...
function HighlightQuery({ text, query }) {
  return (
    <Highlighter
      highlightClassName="group-aria-selected:underline bg-transparent text-brand dark:text-brand"
      searchWords={[query]}
      autoEscape={true}
  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="text-sm text-slate-700 group-aria-selected:text-brand dark:text-slate-300 dark:group-aria-selected:text-brand"
      >
