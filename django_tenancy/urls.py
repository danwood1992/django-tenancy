...
from .views import HomeView, UnpaidRealmView, SignUpView, IssuesView, ContactView, SupportView, login_view, logout_view
...
tenant_patterns = [
    ...
    path('dashboard/<int:realmid>', login_view, name='login_view'),
