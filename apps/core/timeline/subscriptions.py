...
class TimelineSubscription(channels_graphql_ws.Subscription):
    ...
    def publish(payload, info, arg1, arg2):
        ...
        return TimelineSubscription(event="Something has happened!")



class Subscription(graphene.ObjectType):
    """Root GraphQL subscription."""
    timeline_subscription = TimelineSubscription.Field()
